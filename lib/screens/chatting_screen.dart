...
class ChattingScreen extends StatefulWidget {
  final String chaterUserId;
  const ChattingScreen({Key? key, required this.chaterUserId})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: SingleChildScrollView(
        child: Column(
          children: [
            Chatting(chatterUserId: widget.chaterUserId),
            NewMessage(chatterUserId: widget.chaterUserId),
          ],
        ),
      ),
    );
